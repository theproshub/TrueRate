...
export default function ArticleEndNav({ categoryLabel, categoryHref }: ArticleEndNavProps) {
  return (
    <nav aria-label="Continue reading" className="flex flex-wrap items-center gap-2 py-5 my-2 border-t border-b border-gray-200">
      <Link
        href="/"
        className="inline-flex items-center gap-1.5 min-h-[44px] px-4 py-2 rounded-lg bg-[#1E1E1E] text-white text-sm font-semibold no-underline transition-colors hover:bg-[#2a2a2a] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent"
      >
