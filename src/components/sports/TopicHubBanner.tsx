  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-12">
        ...
        <Link
          href={hub.href}
          className="md:col-span-7 group relative no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050d11]"
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-5 bg-gradient-to-t from-black/80 via-black/30 to-transparent">
            <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-red-300 mb-1.5">{hub.kicker}</p>
        ...
        <div className="md:col-span-5 bg-white/[0.03] border-t md:border-t-0 md:border-l border-white/[0.08] p-4 sm:p-5 flex flex-col">
          <Link
            href={hub.lead.href}
            className="group block pb-3 mb-3 border-b border-white/[0.08] no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-1 focus-visible:ring-offset-[#050d11]"
          >
            <p className="text-[10px] font-bold uppercase tracking-wide text-red-400 mb-1">Featured</p>
          ...
          <ul className="flex flex-col">
            {hub.subs.map(s => (
              <li key={s.href} className="border-b border-white/[0.06] last:border-0">
                <Link
                  href={s.href}
                  className="group block py-2.5 no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-1 focus-visible:ring-offset-[#050d11]"
                >
