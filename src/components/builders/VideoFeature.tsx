  ...
  return (
    <section aria-labelledby="builders-videos" className="mb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Featured */}
        <Link href={FEATURED_VIDEO.href} className="group no-underline block">
          <VideoThumbnail
        ...
        <div className="flex flex-col">
          {VIDEO_THUMBS.map((v, i) => (
            <Link key={i} href={v.href} className="group flex gap-3 py-3 first:pt-0 last:pb-0 border-b border-white/[0.05] last:border-0 no-underline">
              <VideoThumbnail
                category={v.category}
