  ...
  return (
    ...
    >
      <Link href="/news" className="group inline-flex items-center gap-1.5 mb-4 no-underline">
        <h2 id="builders-latest" className="text-md font-bold text-white group-hover:text-white/80 transition-colors">
          Latest News
        </h2>
        <span aria-hidden="true" className="text-md font-bold text-white/60 group-hover:text-white/80 transition-colors">›</span>
      </Link>
