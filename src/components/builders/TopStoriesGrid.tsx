    ...
    <section aria-labelledby="builders-top-stories" className="mb-8">
      ...
      <Link href={HERO_STORY.href} className="group no-underline grid grid-cols-1 sm:grid-cols-2 gap-6 mb-7">
        ...
        <div className="flex flex-col justify-center">
          <h3 className="text-xl sm:text-2xl font-bold leading-[1.2] tracking-tight text-gray-900 group-hover:text-gray-600 transition-colors mb-2">
            {HERO_STORY.title}
          </h3>
          {HERO_STORY.dek && (
        ...
        {SECONDARY_STORIES.map((s, i) => (
          <Link key={i} href={s.href} className="group flex gap-3 no-underline">
            ...
            <div className="min-w-0 flex-1">
              <h4 className="text-sm sm:text-base font-semibold leading-snug text-gray-900 group-hover:text-gray-600 transition-colors line-clamp-3 mb-1">{s.title}</h4>
