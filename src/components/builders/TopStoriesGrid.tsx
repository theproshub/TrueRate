...
export default function TopStoriesGrid() {
  return (
    <section aria-labelledby="builders-top-stories" className="mb-8">
      ...
      >
        Entrepreneurship <span className="font-light text-white/40 mx-1">|</span> Top Stories
      </h2>
      ...
      <Link href={HERO_STORY.href} className="group no-underline grid grid-cols-1 sm:grid-cols-2 gap-6 mb-7">
        ...
        <div className="flex flex-col justify-center">
          ...
          {HERO_STORY.dek && (
            <Text className="text-gray-400 leading-relaxed mb-2 line-clamp-3">{HERO_STORY.dek}</Text>
          )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 pt-5 border-t border-white/[0.06]">
