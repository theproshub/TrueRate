      ...
      <div className="mx-auto max-w-[1320px] px-4 py-5">
        <div className="flex flex-col gap-5 sm:flex-row sm:gap-8">
          ...
          <div className="shrink-0 flex flex-col sm:w-[220px]">
            ...
            <p className="-mt-9 text-[13px] text-gray-400 leading-relaxed">
            ...
            <ul className="mt-3 flex items-center gap-3 list-none p-0 m-0">
              <li>
                <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="TrueRate on X"
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-[#0a0a0d] hover:bg-gray-200 transition-colors no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-brand-dark">
