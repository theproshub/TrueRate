...
export const newsItems: NewsItem[] = [
  {
    ...
    body: [
      ...
      "The Committee resolved to maintain the Monetary Policy Rate at 16.25% with a continued cautious tightening bias. The CBL has pointed to continued progress on inflation — which has eased to about 10.2% year-on-year by early 2026, down from a 2024 peak — while signalling it is not yet ready to pivot toward easing. Henry F. Saamoi serves as the CBL's Executive Governor.",
