...
export const newsItems: NewsItem[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The CBL's monetary policy rate, the benchmark that is meant to anchor the cost of credit, has held at 16.3 percent since December 2025. That is down from 20 percent in mid-2024, but the commercial lending rate has not followed it down by the same margin. In February 2026, the average lending rate sat 3.19 percentage points below the policy rate — a sign that the transmission mechanism from central-bank policy to commercial pricing is working, but slowly.",
  ...
  },
  {
    ...
    body: [
      ...
      "The CBL's monetary policy rate at 16.3 percent sets a floor under the structure. The rate has fallen from 20 percent in mid-2024, and the commercial lending rate has followed it down, but not proportionally. The weak transmission suggests that even further policy-rate cuts may not, on their own, produce the lending growth the economy needs.",
