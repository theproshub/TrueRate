...
const movies: TopicContent = {
  hero: {
    category: 'Movies',
    title: "'Sundown in Sinkor' opens to US$1.2M opening weekend across diaspora screens — biggest Liberian-led release since 2019",
    summary: "The Nollywood-Liberia co-production grossed an estimated US$1.18M across 142 screens in the U.S., U.K., and ECOWAS theatrical corridor. Producer Patrice Juah confirmed Filmhouse is exercising its option for a sequel.",
  ...
  kpis: [
    { label: 'Liberian box office (2025)',   value: 'US$3.4M',  delta: '+22% YoY', deltaDirection: 'up',  note: 'TrueRate estimate · domestic + diaspora' },
    { label: 'Avg local production budget',  value: 'US$185K',  delta: '+8% YoY',  deltaDirection: 'up',  note: 'Up from US$171K in 2024' },
  ...
  strip: [
    ...
    { category: 'Movies', title: 'Silverbird Cinemas signs LOI to open four-screen multiplex in Sinkor by Q4 2026 — US$2.8M build-out',                                source: 'FrontPage Africa',  time: '8h ago' },
    ...
    { category: 'Movies', title: 'AfreximBank launches US$30M creative-industries facility — Liberian producers eligible from May 1',                                  source: 'Reuters',           time: '18h ago' },
  ...
  tracker: {
    ...
    rows: [
      { title: 'Sundown in Sinkor',     budget: 'US$1.4M',  opening: 'US$1.18M', screens: '142', studio: 'Filmhouse · Patrice Juah',     status: 'Wide release' },
      { title: 'Pepper Soup',           budget: 'US$420K',  opening: 'US$310K',  screens: '38',  studio: 'Liberty Films',                status: 'Limited' },
      { title: 'Bong County',           budget: 'US$280K',  opening: 'US$94K',   screens: '12',  studio: 'Korkormi Pictures',            status: 'Domestic' },
      { title: 'Mama Ellen',            budget: 'US$1.1M',  opening: 'TBD',    screens: '—',   studio: 'Filmhouse · Inkblot',          status: 'Post-prod' },
      { title: 'The River Mano',        budget: 'US$650K',  opening: 'TBD',    screens: '—',   studio: 'Korkormi · ECOWAS Co-Pro Fund', status: 'Production' },
      { title: 'Gbessay',               budget: 'US$210K',  opening: 'TBD',    screens: '—',   studio: 'Liberty Films · independent',   status: 'Development' },
    ],
  },
  feed: [
    { category: 'Movies', title: "Inside the financing of 'Sundown in Sinkor': how a US$1.4M Nollywood-Liberia co-pro got made",        summary: 'From a Lagos completion-bond facility to a Monrovia tax rebate that did not yet exist when production started, a behind-the-scenes look at the deal stack that put Liberia back on the West African film map.', source: 'TrueRate Culture', time: '11 min read' },
    ...
    { category: 'Movies', title: 'Why Silverbird is betting US$2.8M on a Sinkor multiplex while ticket prices have stagnated',         summary: 'Liberian average ticket price has held at US$4.50 for three years. We modelled the cinema chain\'s break-even and found a four-screen build-out needs 39% capacity utilisation to clear hurdle rate.',                source: 'FrontPage Africa', time: '9 min read'  },
    { category: 'Movies', title: 'Cannes\' 2026 Liberian shorts: the three films, the budgets, and the sales agents attached',        summary: 'A documentary on the LRD (US$72K budget, no sales agent yet), a coming-of-age set in Paynesville (US$45K, repped by Pulse), and a horror short shot in Bong County (US$110K, MK2 attached).',                          source: 'TrueRate Culture', time: '9 min read'  },
    ...
    { category: 'Movies', title: 'AfreximBank\'s US$30M creative facility: the eligibility criteria nobody is reading',                summary: 'The fund is open to Liberian features, but the 30% local-spend requirement and the post-production carve-out exclude most active producers we spoke to. We break down what qualifies.',                            source: 'Reuters',          time: '7 min read'  },
    { category: 'Movies', title: 'Netflix Africa\'s Liberian licensing slate: what the contracts actually say',                       summary: 'Three features at undisclosed MGs in the US$80K–US$150K range, 7-year exclusive windows, and reversion clauses that producers are pushing back on. The line-by-line.',                                              source: 'Variety',          time: '8 min read'  },
  ...
  mostRead: [
    { rank: 1, title: "'Sundown in Sinkor' clears US$1.18M opening — biggest Liberian-led release since 2019", tag: 'Movies' },
    { rank: 2, title: 'Boakai signs 15% film rebate into law — what qualifies and what doesn\'t',             tag: 'Movies' },
    { rank: 3, title: 'Silverbird\'s US$2.8M Sinkor multiplex: the break-even math',                           tag: 'Movies' },
    { rank: 4, title: 'Netflix Africa\'s Liberian licensing terms — line by line',                            tag: 'Movies' },
    { rank: 5, title: 'AfreximBank\'s US$30M facility: who qualifies, who doesn\'t',                            tag: 'Movies' },
  ],
  calendar: [
...
const tv: TopicContent = {
  hero: {
    ...
    summary: "MultiChoice's streaming arm has formally ordered a 10-episode renewal at an estimated per-episode budget of US$185K, up from US$140K in Season 1. Production restarts in Monrovia in June.",
    source: 'TrueRate Culture',
    byline: 'By the TrueRate Culture Desk',
    readTime: '5 min read',
    time: '1h ago',
  ...
  heroStat: {
    ...
    delta: 'US$185K / ep — S2 budget',
    deltaDirection: 'up',
    sub: 'Up from US$140K in Season 1',
  },
  kpis: [
    { label: 'Showmax Liberia subscribers', value: '88,400', delta: '+27% YoY',   deltaDirection: 'up',   note: 'Estimate · paid + bundled' },
    { label: 'LBS ad revenue (2025)',       value: 'US$2.1M',  delta: '−6% YoY',    deltaDirection: 'down', note: 'State broadcaster · auditor-general filing' },
    { label: 'Avg drama ep. budget',        value: 'US$185K',  delta: '+32% YoY',   deltaDirection: 'up',   note: 'Local productions, scripted' },
    { label: 'Hours of LR originals',       value: '74 hrs', delta: '+18 hrs YoY', deltaDirection: 'up',  note: 'Across all platforms' },
  ],
  strip: [
    { category: 'TV', title: "'Bassa Avenue' Season 2 confirmed — Showmax raises per-episode budget to US$185K",                                source: 'TrueRate Culture',  time: '2h ago' },
    ...
    { category: 'TV', title: 'IFC partners with LBS on a US$4M production-fund facility — first commissions go to documentary',                source: 'Reuters',          time: '20h ago' },
  ],
  tracker: {
  ...
  feed: [
    ...
    { category: 'TV', title: 'The IFC-LBS production facility: a US$4M bet that could reshape Liberian documentary',              summary: 'The structure is unusual: matched commissions with reversion to LBS at year five. We talked to two producers already pitching into the first window.',                                                                                  source: 'Reuters',          time: '6 min read' },
    ...
    { category: 'TV', title: 'US$185K an episode: the new floor for Liberian-set scripted drama',                                summary: 'Showmax\'s budget bump on Bassa Avenue is the new benchmark. We broke down where the extra US$45K per episode is going — and which crew lines absorbed most of it.',                                                                          source: 'TrueRate Culture', time: '7 min read' },
  ],
  mostRead: [
    { rank: 1, title: "'Bassa Avenue' Season 2 greenlit at US$185K/episode",         tag: 'TV' },
    ...
    { rank: 5, title: 'IFC + LBS launch a US$4M production fund',                   tag: 'TV' },
  ],
  calendar: [
...
const music: TopicContent = {
  hero: {
    category: 'Music',
    title: "Streaming royalties from Liberian artists hit US$2.3M in 2025 — up 64% YoY as Spotify expands MTN-bundled plans",
  ...
  kpis: [
    { label: 'Streaming royalties (2025)', value: 'US$2.3M',  delta: '+64% YoY',  deltaDirection: 'up',   note: 'Spotify · Apple · Audiomack · YouTube' },
    { label: 'Top monthly listeners',      value: '3.4M',   delta: '+0.8M YoY', deltaDirection: 'up',   note: 'Bucky Raw — global Spotify' },
    { label: 'Avg ticket — Lib Wave',      value: 'US$45',    delta: '+US$8 YoY',   deltaDirection: 'up',   note: 'GA · 2026 festival pricing' },
  ...
  strip: [
    ...
    { category: 'Music', title: "Afrobeats festival 'Lib Wave' confirms Davido, Tems, Stonebwoy headliners for ATS — July 27 — US$1.8M ticket take", source: 'The New Dawn',     time: '4h ago' },
    ...
    { category: 'Music', title: 'Antoinette Tubman Stadium completes US$1.2M sound-system upgrade ahead of Lib Wave festival',                      source: 'FrontPage Africa', time: '20h ago' },
  ],
  tracker: {
    ...
    columns: [
      ...
      { key: 'royalty', label: 'Est. Mo. US$',  align: 'right' },
      { key: 'label',   label: 'Label',       align: 'left',  hideOnMobile: true },
    ],
    rows: [
      { rank: '1', artist: 'Bucky Raw',          genre: 'Hipco',     streams: '8.4M',  royalty: 'US$24,800', label: 'Independent' },
      { rank: '2', artist: 'MC Caro',            genre: 'Hipco',     streams: '5.7M',  royalty: 'US$16,900', label: 'Caro Music Group' },
      { rank: '3', artist: 'Christoph the Change',genre: 'Hipco',    streams: '4.9M',  royalty: 'US$14,500', label: 'Independent' },
      { rank: '4', artist: 'Sundaygar Dearboy',  genre: 'Folk · Pop', streams: '3.8M',  royalty: 'US$11,200', label: 'Mavin sub-label' },
      { rank: '5', artist: 'Erica Williams',     genre: 'Gospel',    streams: '3.1M',  royalty: 'US$9,200',  label: 'Independent' },
      { rank: '6', artist: 'Soul Fresh',         genre: 'R&B · Hipco', streams: '2.6M', royalty: 'US$7,700',  label: 'Independent' },
      { rank: '7', artist: 'Takun J',            genre: 'Hipco',     streams: '2.2M',  royalty: 'US$6,500',  label: 'Independent' },
      { rank: '8', artist: 'Stunna',             genre: 'Afrobeats', streams: '1.9M',  royalty: 'US$5,600',  label: 'Independent' },
    ],
  },
  feed: [
    ...
    { category: 'Music', title: 'Mavin\'s deal with Sundaygar Dearboy: the structure, the advance, and the publishing split',         summary: 'A 360 deal at the Mavin sub-label level with a US$250K advance against royalties. We obtained a redacted summary of the deal terms and broke down where the upside actually sits.',                                              source: 'Variety',          time: '8 min read' },
...
const celebrity: TopicContent = {
  hero: {
    category: 'Celebrity',
    title: "Wayétu Moore's A24 deal: US$1.2M memoir option, co-producer credit attached, Liberia setting required",
  ...
  kpis: [
    { label: 'Top endorsement (annual)', value: 'US$420K',  delta: '+18% YoY', deltaDirection: 'up',   note: 'George Weah Foundation · partner brands' },
  ...
  strip: [
    ...
    { category: 'Celebrity', title: 'Bucky Raw closes Pepsi Liberia endorsement — three-year deal worth an estimated US$180K',                  source: 'TrueRate Culture',  time: '6h ago' },
    ...
    { category: 'Celebrity', title: 'MC Caro launches venture fund "Caro Capital" — US$1.5M first close for Liberian creative startups',         source: 'TechCabal',        time: '10h ago' },
    ...
    { category: 'Celebrity', title: 'Erica Williams Foundation reports US$640K disbursed in 2025 — schools, scholarships, hospital wings',       source: 'TrueRate',         time: '15h ago' },
  ...
  tracker: {
    ...
    rows: [
      { rank: '1', name: 'George Weah',         sector: 'Politics · Sports', income: 'US$1.4M', deals: '5', venture: 'Foundation · property' },
      { rank: '2', name: 'Bucky Raw',           sector: 'Music',             income: 'US$880K', deals: '7', venture: 'Music label · merch' },
      { rank: '3', name: 'Wayétu Moore',        sector: 'Literature · Film', income: 'US$640K', deals: '2', venture: 'Production company' },
      { rank: '4', name: 'MC Caro',             sector: 'Music · Venture',   income: 'US$520K', deals: '4', venture: 'Caro Capital · label' },
      { rank: '5', name: 'Patrice Juah',        sector: 'Film · Venture',    income: 'US$410K', deals: '3', venture: 'Filmhouse Liberia' },
      { rank: '6', name: 'Sundaygar Dearboy',   sector: 'Music',             income: 'US$340K', deals: '4', venture: 'Mavin sub-label deal' },
      { rank: '7', name: 'Erica Williams',      sector: 'Music · Faith',     income: 'US$310K', deals: '3', venture: 'Foundation' },
      { rank: '8', name: 'Christoph the Change',sector: 'Music',             income: 'US$280K', deals: '2', venture: 'Independent' },
    ],
  },
  feed: [
    ...
    { category: 'Celebrity', title: "Caro Capital's US$1.5M first close: who's writing the cheques and what they want",                            summary: 'A celebrity-led venture fund with a US$25K minimum check size. We talked to three of the first five LP commitments and reviewed the term sheet for one of the first portfolio companies.',                            source: 'TechCabal',        time: '8 min read' },
    ...
    { category: 'Celebrity', title: 'Erica Williams Foundation\'s US$640K disbursement: where the money actually went',                            summary: 'School construction, scholarship endowment, two hospital wings, and a small administrative line. We compared the audited figures with the 2024 baseline.',                                                            source: 'TrueRate',         time: '8 min read' },
  ...
  mostRead: [
    { rank: 1, title: 'Wayétu Moore signs A24 — US$1.2M memoir option with co-producer credit',     tag: 'Celebrity' },
    { rank: 2, title: 'Caro Capital first close: US$1.5M and the term sheet that backs it',          tag: 'Celebrity' },
    { rank: 3, title: 'Bucky Raw + Pepsi Liberia: the US$180K deal review',                          tag: 'Celebrity' },
...
const howToWatch: TopicContent = {
  ...
  heroStat: {
    ...
    deltaDirection: 'up',
    sub: 'US$6.30 USD-equivalent · 88,400 subs',
  },
  kpis: [
  ...
  tracker: {
    ...
    rows: [
      { service: 'Showmax', tier: 'Mobile (MTN bundle)', price: '1,200',  usd: 'US$6.30',  subs: '88,400', note: 'Cheapest legal · 480p mobile' },
      { service: 'Spotify', tier: 'Mini (MTN bundle)',   price: '900',    usd: 'US$4.70',  subs: '92,400', note: 'Music · ad-free · 1 device' },
      { service: 'Netflix', tier: 'Standard',            price: '1,950',  usd: 'US$10.20', subs: '32,100', note: 'Localised LRD pricing · Q2' },
      { service: 'Apple TV+', tier: 'Standard',          price: '1,800',  usd: 'US$9.40',  subs: '~7,000', note: '3 months free promo · launch' },
      { service: 'GoTV',    tier: 'Plus',                price: '2,400',  usd: 'US$12.50', subs: '188,000',note: 'Linear · 4 added channels' },
      { service: 'DStv',    tier: 'Compact',             price: '3,200',  usd: 'US$16.70', subs: '64,200', note: 'Linear · subscriber decline' },
      { service: 'DStv',    tier: 'Premium',             price: '6,800',  usd: 'US$35.40', subs: '12,800', note: 'Includes Showmax Premier' },
      { service: 'YouTube', tier: 'Free / Premium',      price: '0 / 1,500', usd: '0 / US$7.80', subs: '4.7M MAU / 11K paid', note: 'Largest free reach · ad-supported' },
    ],
  },
  feed: [
