...
Each: quote (≤30 words, sounds attributable and analytical), speakerName, speakerTitle, speakerOrg (a plausible but composite institution), context line (≤15 words), and a topicTag.
${TOPIC_TAG_RULE}
${avoidBlockText(recentHeadlines)}`;
}
...
Each: value (pre-formatted, e.g. "$2.4T", "87.3%", "12,450 pts"), a one-line descriptor (≤12 words), a comparison/context (≤15 words, e.g. "highest since March 2020"), a topicTag, and a source.
${TOPIC_TAG_RULE}
