...
const OPINION = [
  ...
  { title: "A West African single currency is still coming. Liberia should help shape it, not just join it.", author: 'TrueRate Opinion', role: 'Opinion', time: '4d ago' },
  { title: "Mobile money is racing ahead of the electricity and connectivity it depends on.", author: 'TrueRate Opinion', role: 'Opinion', time: '5d ago' },
  { title: "The Freeport handles most of Liberia's trade. The roads behind it haven't kept up.", author: 'TrueRate Opinion', role: 'Opinion', time: '6d ago' },
];
...
const COMMUNITY_VOICES = [
  ...
  },
  {
    ...
    author: 'TrueRate Technology Desk',
    role: 'Analysis',
    time: '4d ago',
  },
  {
