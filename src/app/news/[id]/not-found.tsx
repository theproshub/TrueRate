  ...
  return (
    <div className="bg-[#f8f9fa] min-h-screen">
      <main className="mx-auto max-w-[720px] px-4 py-24 text-center">
        ...
        <h1 className="text-[32px] sm:text-[40px] font-black leading-tight text-gray-900 mb-4">
          This article doesn&apos;t exist.
        </h1>
        <p className="text-[15px] text-gray-500 leading-relaxed mb-8 max-w-[480px] mx-auto">
