  ...
  if (dbArticle) {
    ...
    return {
      ...
      openGraph: {
        ...
        modifiedTime: dbArticle.updated_at ?? undefined,
        authors: dbArticle.author ? [dbArticle.author.name] : undefined,
        section: dbArticle.category?.label ?? undefined,
        tags: [dbArticle.category?.label, 'Liberia', 'West Africa'].filter(Boolean) as string[],
        siteName: 'TrueRate',
