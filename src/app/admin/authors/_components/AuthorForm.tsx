    ...
    <form action={action} className="space-y-6" noValidate>
      ...
      {notice && (
        <div
          role="status"
          aria-live="polite"
          className="rounded-lg border border-pos/30 bg-pos/[0.06] p-3 text-sm text-pos"
        >
          {notice}
        </div>
      )}
      ...
      <div className="rounded-2xl border border-gray-200 bg-brand-card p-6 space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className={INPUT_BASE}
          />
          <p className={HINT}>External URL or a path under <code className="text-gray-500">/public</code>.</p>
        </div>
