...
function ChangePill({ value, suffix = '%' }: { value: number; suffix?: string }) {
  const up = value >= 0;
  return (
    <span className={`inline-flex items-center gap-0.5 px-1.5 py-px text-[10px] font-semibold tabular-nums ${up ? 'border border-emerald-400/30 bg-emerald-400/[0.08] text-emerald-400' : 'border border-red-400/30 bg-red-500/[0.08] text-red-400'}`}>
