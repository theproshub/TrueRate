  ...
  return (
    <main className="mx-auto max-w-[1320px] px-4 py-6">
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <p className="text-base text-gray-400">Fintech, mobile money, AI, and digital infrastructure in Liberia.</p>
      </div>
      ...
      <section className="mb-8">
        <div className="flex items-center justify-between border-b border-white/[0.07] pb-3 mb-5">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-base font-bold text-white uppercase tracking-[0.12em]">Deep dives</h2>
          </div>
        </div>
      ...
      <section className="mb-10">
        <div className="flex items-center justify-between border-b border-white/[0.07] pb-3 mb-5">
          <h2 className="text-base font-bold text-white uppercase tracking-[0.12em]">Product launches & reviews</h2>
        </div>
