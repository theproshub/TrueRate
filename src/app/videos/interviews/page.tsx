  ...
  return (
    <main className="mx-auto max-w-container px-4 py-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-8">
        ...
        <div className="w-full lg:w-[280px] shrink-0 flex flex-col">
          <div className="mb-4 flex items-center justify-between">
            <span className="text-xs font-black uppercase tracking-widest text-gray-500">Latest interviews</span>
            <a href={CHANNEL_URL} {...ext} className="text-xs text-gray-500 hover:text-gray-900 no-underline">View more ›</a>
          </div>
      ...
      <section className="mb-8">
        <div className="flex items-center justify-between border-b border-gray-200 pb-3 mb-5">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-base font-bold text-gray-900 uppercase tracking-[0.12em]">TrueRate Originals</h2>
          </div>
          <a href={CHANNEL_URL} {...ext} className="text-sm text-gray-500 hover:text-gray-900 no-underline">All series ›</a>
        </div>
      ...
      <section className="mb-10">
        <div className="flex items-center justify-between border-b border-gray-200 pb-3 mb-5">
          <h2 className="text-base font-bold text-gray-900 uppercase tracking-[0.12em]">More interviews</h2>
        </div>
