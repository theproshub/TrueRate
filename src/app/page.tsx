    ...
    <div className="flex flex-col gap-5">
      ...
      <article className="group cursor-pointer">
        ...
        <div className="mt-3">
          ...
          <h2 className="text-[20px] sm:text-[24px] font-bold leading-snug text-white text-center sm:text-left group-hover:text-white/80 transition-colors">
            <Link href={`/news/${featured.id}`} className="no-underline">{featured.title}</Link>
          </h2>
          <p className="mt-2 line-clamp-2 text-[14px] leading-relaxed text-gray-400 text-center sm:text-left">{featured.summary}</p>
        </div>
      </article>
